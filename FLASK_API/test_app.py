...
def test_solver_name_in_filename():
    model_filenames = [
        "M22AIE206_lr_lbfgs.joblib",
        "M22AIE206_lr_liblinear.joblib",
        "M22AIE206_lr_newton-cg.joblib",
        "M22AIE206_lr_sag.joblib",
        "M22AIE206_lr_saga.joblib"
    ]
    for model_filename in model_filenames:
        filename_solver = model_filename.split("_")[-1].split(".")[0]
        print(f"\nFILENAME SOLVER: {filename_solver}")
        ...
        print(f"ACTUAL SOLVER: {model_solver}")
...
def test_post_predict_model():
    ...
    for model_type in model_types:
        ...
        print(f"URL IN USE----> [{f'/predict/{model_type}'}]")
